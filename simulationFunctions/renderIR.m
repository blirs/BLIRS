...
outFile_ir_escaped = strrep(directories.outputfile_ir, filesep(), pythonFileSep);
fileName_ir_escaped = strrep(directories.filename_ir, filesep(), pythonFileSep);
...
newcontents_ir = regexprep(contents_ir, ...
    ...
    sprintf('outputfile = %s', [q,outFile_ir_escaped,q]), ...
    sprintf('filename = %s', [q,fileName_ir_escaped,q]),...
